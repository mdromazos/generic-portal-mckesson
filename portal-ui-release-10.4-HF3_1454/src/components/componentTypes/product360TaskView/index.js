...
const Product360TaskView = ({ component, match}) => {
    ...
    const fetchToken = function () {
        const successCallback = resp => {
            let url = `${component.serverUrl}/html/Hsp.html?embedded=true&authToken=${resp.token.key}&locale=${language}#taskView`;
            setUrl(url);
        };
    ...
    return (
            <Card className="external-link-width" data-testid="p360_task_timelime_card">
...
export default Product360TaskView;
