...
export WAS_CLASSPATH=$WAS_CLASSPATH:$WAS_HOME/runtimes/com.ibm.ws.admin.client_8.5.0.jar:$WAS_HOME/plugins/com.ibm.ws.security.crypto.jar:$WAS_HOME/plugins/com.ibm.ws.runtime.jar
...
$SIP_HOME/lib/ProductVersion.jar:\
$WAS_CLASSPATH \
org.apache.tools.ant.Main -f $PORTAL_HOME/bin/linux/build_ws.xml $target \
$PARAM \
$@
