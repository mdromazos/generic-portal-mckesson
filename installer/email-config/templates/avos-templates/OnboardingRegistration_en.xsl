...
<p>We are pleased to inform you that your user account has been successfully created.</p>
<p>Sign in to our portal to edit your profile, upload documents, upload catalogs, and create additional users.</p>
