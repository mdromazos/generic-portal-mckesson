...
import P360CatalogSettings from '../index';
...
describe('Component setting > Product 360 catalog settings component', () => {
    it('should render product 360 catalog setting component without crashing', async () => {
        ...
        expect(container.querySelector('.product__catalog__container')).not.toBeNull();
