...
import P360TaskViewSettings from '../index';
...
const renderComponent = (props) => render(
    <P360TaskViewSettings
        formikProps={props.formikProps}
    />
);

describe('Component setting > Product 360 taskview settings component', () => {
    it('should render product 360 taskview setting component without crashing', async () => {
        const props = {
            formikProps: {
                values: {},
                touched: {},
        ...
        expect(container.querySelector('.product__task__view__container')).not.toBeNull();
